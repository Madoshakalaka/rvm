...
/// data after the `Layer` has received the `on_close` callback.
///
...
impl Subscriber for Registry {
    ...
    fn try_close(&self, id: span::Id) -> bool {
        ...
        // fixme: I don't know how
        #[allow(deprecated)] if !std::thread::panicking() {
...
impl<'a> CloseGuard<'a> {
    pub(crate) fn mut_is_closing(&mut self) {
